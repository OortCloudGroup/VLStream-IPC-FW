...
ifeq ($(PLATFORM),CENTOS32)
	...
	export HOME
	INC = -I. -I$(HOME)/include 
	CFLAGS = $(INC) -I. -I../include -finline-functions -D__LINUX_FILE__ -DHAVE_EPOLL -O3 -fomit-frame-pointer -fPIE -pipe  -Dlinux -D__linux__ -Dunix -DEMBED -D_GNU_SOURCE -msoft-float #-pipe
	MYLIB = $(HOME)/lib
	LDFLAGS = -L. -L$(MYLIB) -L../lib
endif
